...
#include "../../AtticMusic/musiclist.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_musicList_t, stringdata) + ofs \
...
void musicList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&musicList::listClose)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject musicList::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_musicList.data,
      qt_meta_data_musicList,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_musicList.stringdata))
